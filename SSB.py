...
from concurrent.futures import ThreadPoolExecutor as SSBSSB
from string import * 
...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            SSB
\033[1;37m Facebook:            SSB
\033[1;37m Github  :            SSB
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with SSBSSB(max_workers=30) as SSBworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    print(" ")
    SSB = input('Saving Put File Name :')
    os.system('touch ' +SSB)
    os.system('sort -r '+SSB+' | uniq > '+SSB)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + SSB )
    print(47*'-')
    print("File Saved To :" + SSB )
    print(47*'-')
